...
public class ESalvarParguela extends Estado {

	private static Accion AC = new SalvaParguela();
	public static final String ID = "ESalvarParguela";

	public ESalvarParguela() {
