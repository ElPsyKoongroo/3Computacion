...
//
// FUNCIÓN: Material::SetUniforms(CGShaderProgram* program)
//
...
//
// FUNCIÓN: void Material::InitTexture(const char* filename)
//
// PROPÓSITO: Carga una textura
//
void Material::InitTexture(const char* filename)
{
